...
AFRAME.registerComponent('gesture-handler', {
  ...
  fromUI: function (e) {
    const t = e.target;
    return t && t.closest && t.closest('button, input, .dock, .spawn-bar, #intro, .place-hint, .status, #help-modal, .btn-help');
  },
...
const btnHelpIntro = $('btn-help-intro');
...
if (btnHelpIntro) btnHelpIntro.addEventListener('click', openHelp);
